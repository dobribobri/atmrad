...
if __name__ == '__main__':
    ...
    for beta in beta_range:
        ...
        for i, dm in enumerate(DIAP):
            ...
            for kernel in kernels:
                print('\r{:.2f}%\t-\t({}, {})'.format(i / (len(DIAP) - 1) * 100, kernel, kernel), end='  ', flush=True)
                ...
                # conv_h = np.power(conv_w / 0.132574, 1. / 2.30215)

                solid.liquid_water = Cloudiness3D(kilometers=(1, 1 * len(conv_h), H),
