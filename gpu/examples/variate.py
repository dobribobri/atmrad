...
if __name__ == '__main__':
    ...
    for THETA in THETAS:
        ...
        distributions = [
            ...
            {'name': 'L2B00', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': -0.9,
             'cl_bottom': 1.2192},
            {'name': 'L2B01', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': -0.8,
             'cl_bottom': 1.2192},
            {'name': 'L2B02', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': -0.7,
             'cl_bottom': 1.2192},
            {'name': 'L2B03', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': -0.6,
             'cl_bottom': 1.2192},
            {'name': 'L2B04', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': -0.5,
             'cl_bottom': 1.2192},
            {'name': 'L2B05', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': -0.4,
             'cl_bottom': 1.2192},
            {'name': 'L2B06', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': -0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2B07', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': -0.2,
             'cl_bottom': 1.2192},
            {'name': 'L2B08', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': -0.1,
             'cl_bottom': 1.2192},
            {'name': 'L2B09', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': 0.0,
             'cl_bottom': 1.2192},
            {'name': 'L2B10', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': 0.1,
             'cl_bottom': 1.2192},
            {'name': 'L2B11', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': 0.2,
             'cl_bottom': 1.2192},
            {'name': 'L2B12', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2B13', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': 0.4,
             'cl_bottom': 1.2192},
            {'name': 'L2B14', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': 0.5,
             'cl_bottom': 1.2192},
            {'name': 'L2B15', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': 0.6,
             'cl_bottom': 1.2192},
            {'name': 'L2B16', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': 0.7,
             'cl_bottom': 1.2192},
            {'name': 'L2B17', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': 0.8,
             'cl_bottom': 1.2192},

            {'name': 'L2E00', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.53, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2E01', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.63, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2E02', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.73, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2E03', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.83, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2E04', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 0.93, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2E05', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 1.03, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2E06', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 1.13, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2E07', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 1.23, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2E08', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 1.33, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2E09', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 1.43, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2E10', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 1.53, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2E11', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 1.63, 'beta': 0.3,
             'cl_bottom': 1.2192},
            {'name': 'L2E12', 'alpha': 1.411, 'Dm': 4.026, 'dm': 0.02286, 'eta': 1.73, 'beta': 0.3,
             'cl_bottom': 1.2192},
        ...
        for distr in distributions:
            ...
            for ID, required_percentage in enumerate(percentage):
                ...
                for kernel in kernels:
                    ...
                    conv_q = map2d.conv_averaging(Q, kernel=kernel)
                    QINI.append(np.mean(conv_q))
                    ...
                    append_stats(QBRT, [sys.maxsize], frequencies[0])
                    append_stats(QSOL, [sys.maxsize], frequencies[0])
                    append_stats(DQSB, [sys.maxsize], frequencies[0])
                    append_stats(DQBI, [sys.maxsize], frequencies[0])
                    append_stats(DQSI, [sys.maxsize], frequencies[0])
                    append_stats(DQSBI, [sys.maxsize], frequencies[0])
                    append_stats(DQBII, [sys.maxsize], frequencies[0])
                    append_stats(DQSII, [sys.maxsize], frequencies[0])
                    ...
                    for i, (nu1, nu2) in enumerate([(frequencies[0], frequencies[j]) for j in range(1, len(frequencies))]):
                        ...
                        sol = math.linalg_solve(mat, right)
                        wbrt = np.asarray(sol[1, :], dtype=float)
                        qbrt = np.asarray(sol[0, :], dtype=float)

                        append_stats(WBRT, wbrt, nu2)
                        append_stats(QBRT, qbrt, nu2)
                        ...
                        qsolid = np.asarray(sol[0, :], dtype=float)

                        append_stats(WSOL, wsolid, nu2)
                        append_stats(QSOL, qsolid, nu2)

                        append_stats(DWSB, wsolid - wbrt, nu2)
                        append_stats(DWBI, wbrt - conv_w, nu2)
                        append_stats(DWSI, wsolid - conv_w, nu2)

                        append_stats(DQSB, qsolid - qbrt, nu2)
                        append_stats(DQBI, qbrt - conv_q, nu2)
                        append_stats(DQSI, qsolid - conv_q, nu2)
                        ...
                        with warnings.catch_warnings():
                            ...
                            delta = (qsolid - qbrt) / conv_q
                            append_stats(DQSBI, delta, nu2)

                            delta = (qbrt - conv_q) / conv_q
                            append_stats(DQBII, delta, nu2)

                            delta = (qsolid - conv_q) / conv_q
                            append_stats(DQSII, delta, nu2)
                ...
                data = {
                    ...
                    'Q': {
                        # 'map': Q,
                        # 'total_max': np.max(Q),
                        'total_mean': np.mean(Q),
                        # 'total_min': np.min(Q),
                        # 'total_var': np.var(Q),
                        # 'total_std': np.std(Q),
                        # 'total_range': np.max(Q) - np.min(Q),
