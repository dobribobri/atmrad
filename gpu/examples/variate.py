...
#
#             WINI = {'mean': [], 'min': [], 'max': [], 'var': [], 'std': [], 'range': []}
#             QINI = {'mean': [], 'min': [], 'max': [], 'var': [], 'std': [], 'range': []}
#
#             # template = {
#             #     'mean': defaultdict(list), 'min': defaultdict(list), 'max': defaultdict(list),
#             #     'var': defaultdict(list), 'std': defaultdict(list), 'range': defaultdict(list),
...
#
#                 conv_q = map2d.conv_averaging(Q, kernel=kernel)
#                 QINI['mean'].append(np.mean(conv_q))
#                 QINI['min'].append(np.min(conv_q))
#                 QINI['max'].append(np.max(conv_q))
#                 QINI['var'].append(np.var(conv_q))
#                 QINI['std'].append(np.std(conv_q))
#                 QINI['range'].append(np.max(conv_q) - np.min(conv_q))
#
#                 # обратный переход от водозапаса к высотам с учетом сделанной ранее коррекции
#                 conv_h = np.power(conv_w / _c0, 1. / _c1)
#
...
#                         append_stats(DWSII, delta, nu2)
#
#                         append_stats(DQSBI, (qsolid - qbrt) / conv_q, nu2)
#                         append_stats(DQBII, (qbrt - conv_q) / conv_q, nu2)
#                         append_stats(DQSII, (qsolid - conv_q) / conv_q, nu2)
#
#             data = {
#                 'name': distr['name'],
#                 'part': ID,
